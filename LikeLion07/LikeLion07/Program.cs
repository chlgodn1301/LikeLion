...
namespace LikeLion07
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            float floatNum = 3.14f;         // 단정밀도 실수 (f를 붙여줘야함)
            ...
            decimal highPrecision = 3.141592653545123412431243m;    // 고정밀도 (16바이트)
            ...
            // 닷넷 형식 : 기본 형식의 닷넷표현 (외부의 using.System없을때)
            /*System.Int32 number = 123;     // int 닷넷 형식
            ...
            string flagAsString = flag.ToString();      // 논리값을 문자열로 변호나
